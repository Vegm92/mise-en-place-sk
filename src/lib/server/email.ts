...
const LOGO_SVG = '<svg viewBox="0 0 24 24" width="20" height="20" fill="none"><rect x="2.5" y="3.5" width="3" height="17" rx="1.2" stroke="currentColor" stroke-width="1.6"></rect><rect x="10.5" y="3.5" width="3" height="13" rx="1.2" stroke="currentColor" stroke-width="1.6"></rect><rect x="18.5" y="3.5" width="3" height="9" rx="1.2" stroke="currentColor" stroke-width="1.6"></rect></svg>';

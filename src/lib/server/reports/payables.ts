...
const BUCKETS = [
	{ label: 'rep.bucket.notDue', min: -Infinity, max: -1, shade: 0.18 },
	{ label: 'rep.bucket.d0', min: 0, max: 30, shade: 0.38 },
	{ label: 'rep.bucket.d31', min: 31, max: 60, shade: 0.62 },
	{ label: 'rep.bucket.d61', min: 61, max: Infinity, shade: 0.9 },
] as const;

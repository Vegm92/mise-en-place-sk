...
const translations = {
  es: {
    ...
    'extract.discrepancyDesc': 'El total extraído no cuadra con la suma de las líneas + IVA. Revisa antes de confirmar.',
    ...
    'extract.taxBase':         'Base imponible',
    'extract.vat':             'IVA (10%)',
  ...
  en: {
    ...
    'extract.discrepancyDesc': 'The extracted total doesn\'t match the sum of lines + VAT. Review before confirming.',

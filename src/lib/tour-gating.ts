export const TOUR_PAGES = [
	...
	{ step: '6',  path: '/products',        anchor: 'products-main' },
	{ step: '7',  path: '/suppliers',       anchor: 'suppliers-main' },
	{ step: '8',  path: '/recipes',         anchor: 'recipes-main' },
	{ step: '9',  path: '/billing',         anchor: 'billing-main' },

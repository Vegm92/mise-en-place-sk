  ...
  <div style="padding:14px 18px 0;flex-shrink:0;">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;">
      ...
      <div style="flex:1;min-width:0;">
        <h1 class="m-0 mb-[3px] text-lg font-semibold text-fg tracking-[-0.3px] truncate">{s.name}</h1>
          ...
          <div style="display:flex;flex-direction:column;gap:8px;">
            {#if s.contactEmail}
              <div class="flex items-center gap-2.5 text-[12.5px] text-fg-2">
                ...
                <a href="mailto:{s.contactEmail}" class="text-fg-2 no-underline truncate inline-flex items-center min-h-[44px]">{s.contactEmail}</a>
              </div>
            {/if}
            {#if s.contactPhone}
              <div class="flex items-center gap-2.5 text-[12.5px] text-fg-2">
      ...
      {#if data.invoices.length}
        <div class="card" style="padding:0;overflow:hidden;">
          ...
          {#each data.invoices.slice(0, 4) as inv (inv.id)}
            <a href="/invoice/{inv.id}" class="py-[10px] px-[14px] flex items-center gap-2.5 border-t border-divider no-underline text-inherit">
              <div style="flex:1;min-width:0;">
            ...
            <div style="display:flex;flex-direction:column;gap:7px;width:100%;">
              {#each productDonut.slices as slice}
                <div style="display:flex;align-items:center;gap:8px;">
                  ...
                  <span class="text-[12px] text-fg-2 flex-1 min-w-0 truncate">{slice.label}</span>

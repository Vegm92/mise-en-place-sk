...
<div style="padding:28px 32px;max-width:1180px;margin:0 auto;display:flex;flex-direction:column;gap:24px;">
  ...
  <div style="display:flex;align-items:baseline;gap:12px;flex-wrap:wrap;">
    <h2 style="margin:0;font-size:22px;font-weight:600;color:var(--mep-fg);letter-spacing:-0.3px;">{$t('admin.rev.title')}</h2>
    <span style="font-size:12px;color:var(--mep-fg-3);">{o.month}</span>
  ...
  <div class="card" style="padding:14px 16px;display:flex;gap:14px;align-items:center;flex-wrap:wrap;">
    ...
    <form method="POST" action="?/snapshot">
      <button type="submit" style="padding:6px 12px;background:var(--mep-fg);color:var(--mep-bg);border:0;border-radius:6px;font-size:12px;font-weight:500;cursor:pointer;">
        {$t('admin.rev.captureNow')}
      </button>
    </form>
    <form method="POST" action="?/backfill">
      <button type="submit" style="padding:6px 12px;background:var(--mep-surface);color:var(--mep-fg);border:1px solid var(--mep-divider,#e5e5e5);border-radius:6px;font-size:12px;font-weight:500;cursor:pointer;">
  ...
  <section>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:12px;">
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.mrr')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{eur(o.mrrCents)}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.arr')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{eur(o.arrCents)}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.payingCustomers')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{o.payingCustomers}</div>
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">{$ti('admin.rev.trialsSub', { n: o.trialCustomers })}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.arpa')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{eur2(o.arpaCents)}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.acv')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{eur(o.acvCents)}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.atRisk')}</div>
        <div style="font-size:26px;font-weight:700;color:{o.atRiskMrrCents > 0 ? '#dc2626' : 'var(--mep-fg)'};letter-spacing:-0.5px;" class="num">{eur(o.atRiskMrrCents)}</div>
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">{$ti('admin.rev.atRiskSub', { n: o.atRiskCustomers })}</div>
      </div>
    </div>
  </section>
  ...
  <section>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px;">
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.cac')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">
          {o.cacCents === null ? '—' : eur2(o.cacCents)}
        </div>
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">
          {$ti('admin.rev.cacBasis', { spend: eur(o.cacSpendCents), n: o.cacNewCustomers, from: o.cacWindowFrom, to: o.cacWindowTo })}
        </div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.ltv')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{eur(o.ltvCents)}</div>
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">
          {$ti('admin.rev.ltvBasis', { months: months(o.lifetimeMonths), margin: o.assumptions.grossMarginPct })}
        </div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.ltvCac')}</div>
        ...
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">{$ti('admin.rev.target', { n: HEALTHY_LTV_CAC_RATIO })}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.payback')}</div>
        ...
        <div style="font-size:11px;color:var(--mep-fg-4);margin-top:4px;">{$t('admin.rev.monthsUnit')}</div>
      </div>
    </div>
  </section>
  ...
  <section>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:12px;">
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.nrrAnnual')}</div>
      ...
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.nrrMonthly')}</div>
      ...
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.grr')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{pct(o.grrMonthly)}</div>
      </div>
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.logoChurn')}</div>
      ...
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.revenueChurn')}</div>
      ...
      <div class="card" style="padding:16px;">
        <div style="font-size:11px;color:var(--mep-fg-3);margin-bottom:6px;">{$t('admin.rev.avgChurn')}</div>
        <div style="font-size:26px;font-weight:700;color:var(--mep-fg);letter-spacing:-0.5px;" class="num">{pct(o.avgMonthlyChurn)}</div>
      </div>
    </div>
  </section>
        ...
        <tbody>
          {#each o.funnel as stage}
            <tr style="border-bottom:1px solid var(--mep-divider,#e5e5e5);">
              ...
              <td style="padding:9px 16px;text-align:right;color:{stage.dropFromPrevious ? '#dc2626' : 'var(--mep-fg-4)'};font-size:12px;" class="num">
  ...
  <section>
    ...
    <div class="card" style="padding:16px;">
      <form method="POST" action="?/saveAssumptions" style="display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end;">
        ...
        <button type="submit" style="padding:7px 14px;background:var(--mep-fg);color:var(--mep-bg);border:0;border-radius:6px;font-size:13px;font-weight:500;cursor:pointer;">
  ...
  <section>
    <a href="/admin" style="font-size:13px;color:var(--mep-fg-2);text-decoration:none;">{$t('admin.backToOverview')}</a>
  </section>

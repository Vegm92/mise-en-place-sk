...
description: >
  ...
  display, not a persistent mode. Trigger: /ponytail-help, "ponytail help",
...
| **ponytail-audit** | `/ponytail-audit` | Repo-wide over-engineering scan. Ranked findings, no fixes applied. |

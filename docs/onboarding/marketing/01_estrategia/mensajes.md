...
```mermaid
flowchart TD
    P["Sabe en qué gasta tu cocina,<br/>antes que tú"]
    P --> A["1 · Deja de teclear<br/><i>tiempo</i>"]
    P --> B["2 · Entérate el mismo día<br/><i>dinero</i>"]
    P --> C["3 · Fíate del dato<br/><i>confianza</i>"]
```

...
2. **Obligación legal inminente.** En 2027 **todos** los restaurantes españoles deberán usar software de facturación certificado (VERI*FACTU: 1 ene./1 jul. 2027, RDL 15/2025, fecha firme). Además deberán recibir factura electrónica B2B estructurada con reporte de estados de pago (RD 238/2026, Ley Crea y Crece; previsto oct. 2027 / oct. 2028, pendiente de orden ministerial). La digitalización de la factura de proveedor pasa de "deseable" a **legalmente inevitable**. Nosotros montamos la ola; no necesitamos crearla.

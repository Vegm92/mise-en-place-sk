...
**Status:** Active, amended by [ADR-032](./ADR-032-the-ink-gains-a-hue.md)
**Feature:** experience
**Date:** 2026-08-26
...
## Update — the ink gains a temperature (ADR-032)

The rule below survives; the values in the two tables above do not.
[ADR-032](./ADR-032-the-ink-gains-a-hue.md) keeps `--mep-acc` as the ink doing
...
accent is the ink*; read ADR-032 for *what the ink currently is*. The
ink/parchment brand pair recorded in the icon update below likewise moves to
`#1B2A44` on `#ECEDF1`.

## Related

- [ADR-032](./ADR-032-the-ink-gains-a-hue.md) — amends this: same rule, warmer

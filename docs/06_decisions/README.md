...
| [018](./insights/ADR-018-one-snapshot-for-chat-and-digest.md) | Chat and digest read one Markdown snapshot, never the database | Active for the digest, amended by 040 for chat |
...
| [040](./insights/ADR-040-bounded-tool-calling-supplements-the-chat-snapshot.md) | Chat gains bounded, tenant-scoped tool calls on top of the snapshot; the digest does not | Active |
...
| [043](./conventions/ADR-043-security-controls-fail-closed-in-production.md) | Security controls fail closed in production and fail open only in development | Active |

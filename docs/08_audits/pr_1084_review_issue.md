...
PR #1084 addressed issue #1067 where Railway / platform liveness probes lacking `x-forwarded-for` headers triggered an uncaught exception from SvelteKit's `getClientAddress()`, resulting in HTTP 500 errors and false-positive outage alerts.

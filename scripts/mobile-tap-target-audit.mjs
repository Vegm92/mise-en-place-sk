 ...
 *   node scripts/mobile-tap-target-audit.mjs                   # writes tests/fixtures/mobile-tap-targets.json
 *
 * Flags:
 *   --base-url=<url>   default http://127.0.0.1:5209
 *   --width=<px>       default 390 (>= 768 drops the phone emulation)
 *   --height=<px>      default 844
 *   --out=<path>       default tests/fixtures/mobile-tap-targets.json ('-' for stdout only)
...
const DEFAULTS = {
	...
	width: 390,
	height: 844,
	out: 'tests/fixtures/mobile-tap-targets.json',

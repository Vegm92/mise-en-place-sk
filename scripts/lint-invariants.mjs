...
const INLINE_TOKEN_STYLE_BUDGET = new Map([
	['src/routes/(app)/+layout.svelte', 14],
	['src/routes/(app)/budgets/+page.svelte', 4],
	['src/lib/components/UploadPanel.svelte', 2],
	['src/routes/(app)/analytics/prices/+page.svelte', 1],
	['src/lib/components/mobile/MobileInvoiceDetail.svelte', 1],
	['src/routes/signup/+page.svelte', 1],
	['src/routes/(admin)/admin/+page.svelte', 1],
	['src/routes/(app)/analytics/spend/+page.svelte', 1],
	['src/lib/components/mobile/MobileProducts.svelte', 1],
